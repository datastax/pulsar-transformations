 ...
 */
@Slf4j
public class TransformFunction implements Function<GenericObject, Record<Object>>, TransformStep {
  ...
  @Override
  public Record<Object> process(GenericObject input, Context context) throws Exception {
