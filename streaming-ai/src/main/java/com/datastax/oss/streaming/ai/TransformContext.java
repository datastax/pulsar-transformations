    ...
    switch (schemaType) {
      case AVRO:
        ...
        return OBJECT_MAPPER.convertValue(
            JsonConverter.toJson((GenericRecord) val), new TypeReference<Map<String, Object>>() {});
      case JSON:
  ...
  public void setResultField(
    ...
    if (fieldName == null || fieldName.equals("value")) {
      ...
      if (valueObject instanceof Map) {
        ...
        Schema.Field fieldSchemaField = new Schema.Field(valueFieldName, fieldSchema, null, null);
      ...
      if (keyObject instanceof Map) {
        ...
        Schema.Field fieldSchemaField = new Schema.Field(keyFieldName, fieldSchema, null, null);
