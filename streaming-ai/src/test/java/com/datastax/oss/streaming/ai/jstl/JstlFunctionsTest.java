...
public class JstlFunctionsTest {
  ...
  @Test
  void testUnpack() {
    assertEquals(map("field1", "1", "field2", "2"),
            JstlFunctions.unpack("1,2", "field1,field2"));
    ...
    assertEquals(map("field1", "1", "field2", "2", "field3", null),
            JstlFunctions.unpack("1,2", "field1,field2,field3"));
    assertEquals(map("field1", "1", "field2", null),
            JstlFunctions.unpack("1", "field1,field2"));


    assertEquals(map("field1", "1", "field2", "2"),
            JstlFunctions.unpack(JstlFunctions.split("1:2", ":"), "field1,field2"));

    assertEquals(map("field1", 1f, "field2", 2f),
  ...
  private static Map<String, Object> map(String key, Object nullableValue, String key2, Object nullableValue2) {
  ...
  private static Map<String, Object> map(String key, Object nullableValue, String key2, Object nullableValue2,
                                         String key3, Object nullableValue3) {
    Map<String, Object> map = new HashMap<>();
    map.put(key, nullableValue);
    map.put(key2, nullableValue2);
