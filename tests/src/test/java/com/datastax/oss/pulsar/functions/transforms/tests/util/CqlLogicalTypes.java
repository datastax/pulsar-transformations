...
public class CqlLogicalTypes {
  ...
  public static final org.apache.avro.Schema decimalType =
  ...
  public static org.apache.avro.generic.GenericRecord createDecimalRecord(BigDecimal decimal) {
    org.apache.avro.generic.GenericRecord decimalRecord =
        new GenericData.Record(CqlLogicalTypes.decimalType);
    decimalRecord.put(
        CqlLogicalTypes.CQL_DECIMAL_BIGINT, ByteBuffer.wrap(decimal.unscaledValue().toByteArray()));
