...
| `BOOLEAN`              | true or false                                                                                | `BOOLEAN`          | `boolean`                   | "true", expression2: "1 == 1", "value.stringField == 'matching string'" |
| `DATE`                 | A date/time object with an offset from UTC resembling the old Java 8 type.<br>               | `date`             | `date` (logical)            | "'2022-10-02T00:00:00Z'", "1664668800000" (millis), 19267 (days)        |
|                        | The input can be a string in the RFC3339 format or number of millis since epoch.<br>         |                    |                             |                                                                         | 
|                        | Please note that in AVRO, this will translate to number of days since epoch and the time <br>|                    |                             |                                                                         |
|                        | part will be ignored.                                                                        |                    |                             |                                                                         |
| `TIME`                 | A time without a time-zone in the RFC3339 format.                                            | `TIME`             | `time-millis` (logical)     | "'10:15:30'", "36930000" (millis) since 00:00:00                        |
| `TIMESTAMP`            | A date/time object with an offset from UTC. <br>                                             | `TIMESTAMP`        | `timestamp-millis` (logical)| "'2022-10-02T01:02:03+02:00'", "1664665323000" (millis), "fn:now()"     |
|                        | The input can be a string in the RFC3339 fo rmat or number of millis since epoch.            |                    |                             |                                                                         |
| `INSTANT`              | A date/time object with an offset from UTC. <br>                                             | `INSTANT`          | `timestamp-millis` (logical)| "'2022-10-02T01:02:03+02:00'", "1664665323000" (millis), "fn:now()"     |
|                        | The input can be a string in the RFC3339 format or number of millis since epoch.             |                    |                             |                                                                         |
| `LOCAL_DATE`           | A date without a time-zone in the RFC3339.                                                   | `LOCAL_DATE`       | `date`  (logical)           | "'2022-10-02'", "19267" (days)                                          |
| `LOCAL_TIME`           | A time without a time-zone in the RFC3339.                                                   | `LOCAL_TIME`       | `time-millis` (logical)     | "'10:15:30'", "36930000" (millis) since 00:00:00                        |
| `LOCAL_DATE_TIME`      | A date/time object with an offset from UTC.                                                  | `LOCAL_DATE_TIME`  | `timestamp-millis` (logical)| "'2022-10-02T01:02:03+02:00'", "1664665323000" (millis)                 |
|                        | The input can be a string in the RFC3339 format or number of millis since epoch.             |                    |                             |                                                                         |
| `BYTES`                | A sequence of 8-bit unsigned bytes                                                           | `BYTES`            | `bytes`                     | "'input'.bytes"                                                         |
| `DATETIME`(deprecated) | Use INSTANT instrad to represent a full date-time with an offset from UTC.                   | `INSTANT`          | `timestamp-millis` (logical)| "2022-10-02T01:02:03+02:00"                                             |
