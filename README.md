...
| `DATE`            | A timestamp in UTC time-zone.<br>When applied on an AVRO field, it will be converted to a number of days since Epoch. | `DATE`             | `date` (logical)             | "'2022-10-02T00:00:00Z'", "1664668800000" (millis)                  |
