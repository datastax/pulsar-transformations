...
|                        | The input can be a string in the RFC3339 format or number of millis since epoch.             |                    |                             |                                                                         |
| `LOCAL_DATE`           | A date without a time-zone in the RFC3339 format.                                            | `LOCAL_DATE`       | `date`  (logical)           | "'2022-10-02'", "19267" (days)                                          |
| `LOCAL_TIME`           | A time without a time-zone in the RFC3339 format.                                            | `LOCAL_TIME`       | `time-millis` (logical)     | "'10:15:30'", "36930000" (millis) since 00:00:00                        |
| `LOCAL_DATE_TIME`      | A date/time object without a time-zone in the RFC3339 format.                                | `LOCAL_DATE_TIME`  | `timestamp-millis` (logical)| "'2022-10-02T01:02:03+02:00'", "1664665323000" (millis)                 |
|                        | The input can be a string in the RFC3339 format or number of millis since epoch.             |                    |                             |                                                                         |
