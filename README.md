...
| `TIMESTAMP`            | A date/time object in UTC time-zone.                                                          | `TIMESTAMP`        | `timestamp-millis` (logical)| "'2022-10-02T01:02:03+02:00'", "1664665323000" (millis), "fn:now()"     |
| `INSTANT`              | An instantaneous point on the time-line.                                                      | `INSTANT`          | `timestamp-millis` (logical)| "'2022-10-02T01:02:03+02:00'", "1664665323000" (millis), "fn:now()"     |
...
| `LOCAL_DATE_TIME`      | A date/time object without a time-zone.                                                       | `LOCAL_DATE_TIME`  | `timestamp-millis` (logical)| "'2022-10-02T01:02:03+02:00'", "1664665323000" (millis)                 |
